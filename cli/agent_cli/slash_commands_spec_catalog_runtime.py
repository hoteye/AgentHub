"""Static slash command spec catalog."""
...
from cli.agent_cli.slash_commands_background_specs_runtime import background_slash_command_specs
...
SLASH_COMMAND_SPECS: tuple[SlashCommandSpec, ...] = (
    ...
    *background_slash_command_specs(SlashCommandSpec, surface_usage_text),
    SlashCommandSpec(
        "runtime_config",
