...
# Detailed comparison script v2 for Reference vs AgentHub
# - 300 second timeout
# - Detailed logging of tool calls and intermediate results

PROMPT="看看仓库的规模和质量"
TEST_DIR="/home/lyc/project/AgentHub/cli"
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
LOG_DIR="/tmp/agenthub_reference_comparison_${TIMESTAMP}"
TIMEOUT=400

mkdir -p "${LOG_DIR}"

echo "========================================="
echo "Comparison Test v2"
...
echo "========================================="
echo ""
echo "To view Reference execution:"
echo "  cat ${LOG_DIR}/reference_full_output.log"
echo ""
echo "To view AgentHub execution:"
echo "  cat ${LOG_DIR}/agenthub_full_output.log"
echo ""
echo "To view comparison summary:"
echo "  cat ${LOG_DIR}/comparison_summary.txt"
